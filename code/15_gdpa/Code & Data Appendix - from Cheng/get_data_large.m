function [dataset_str,read_data] = get_data_large(dataset_i)
...
elseif dataset_i==18
    read_data1 = importdata('cod-rna.csv');
    read_data2 = importdata('cod-rnat.csv');
    read_data3 = importdata('cod-rnar.csv');
    read_data = [read_data1;read_data2;read_data3];
    dataset_str = 'cod-rna';
end
end
