...
train_des = train_des(1:6:end,1:16:end);
train_lbls = train_lbls(1:6:end,1:16:end);
...
%=other parameters=========================================================
gamma = 1; % free parameter in the objective
beta = 1; % free parameter in the objective
