...
def cnstr_glr(B, deriv, mu, x, F, edges):
    ...
    # debug
    print('-----------------------------------------------')
    print('* function sg.cnstr_glr is called. Here are the inputs:')
    # print('* B = \n', B)
    # print('* deriv = ', deriv)
    # print('* mu = ', mu)
    # print('* x = ', x)
...
def cnstr_glr_dummy(B, deriv, mu, x, F, edges):
    """
    Compute loss function and its derivative w.r.t. B for a potentially sparse graph
    Loss = r + l  s.t.
           r = x.T @ L @ x , 
    ...
    # debug
    print('* function sg.cnstr_glr_dummy is called. Here are the inputs:')
    print('* B = \n', B)
    print('* deriv = ', deriv)
    print('* mu = ', mu)
    print('* x = ', x)
...
def gradient_descent(loss_func, opt_params, show_nrmdE = False):
    ...
    # debug
    # print('^ function sg.gradient_descent is called. Here are the inputs:')
    # print('^ loss_func = ', loss_func)
    # print('^ opt_params = ', opt_params.items())
    ...
    print('exit sg.gradient_descent')
    return Theta, stats


def fit_graph(dess, lbls, opt_params, mux = 0, D = None, seed = None, edgesx = None):  
    """
    ...
    #debug
    print('entered sg.fit_graph. Here are the inputs:')
    print('dess\n', dess)
    print('lbls\n', lbls)
    print('opt_params\n', opt_params)
    print('D\n', D)
    ...
    if opt_params['Theta0'] is None:
        ...
        #debug
        print('Theta0 was changed to:\n', opt_params['Theta0'])

    xs = lbls * 2 - 1
    if edgesx is None:
        edgesx = get_edges(xs, D, seed)
    ...
    if opt_params['print_checks']:
        ...
        print('mu = ' + str(mux))
        print('number of edges: ', len(edgesx))
    ...
    def cnstr_glr_wrap(B, deriv=False):
        #debug
        # print('@ function sg.cnstr_glr_wrap is called. Here are the inputs:')
        # print('@ B =\n', B)
        # print('@ deriv = ', deriv)
        return cnstr_glr(B, deriv, mu=mux, x=xs, F=dess.T, edges=edgesx)
...
def extrapolate_original(B, train_des, val_des, train_gt):
    ...
    """
    #debug
    print('function sg.extrapolate is called. Here are the inputs:')
    print('B = \n', B)
    print('train_des =\n', train_des)
    print('val_des = \n', val_des)
    print('train_gt = \n', train_gt)
    ...
    #debug
    print('# of train points: ', num_train)
    print('# of val points: ', num_val)
    print('# of features for each point: ', f_sz)
    ...
    #debug
    #print('train and val dess are concatenated to form data_des:\n', data_des)
...
def get_acc(B, train_des, train_y, val_des, val_y):
    ...
    #debug
    print('sg.get_acc is called. Here are the inputs:')
    print('B = \n', B)
    print('train_des =\n', train_des)
    print('train_y = \n', train_y)
    print('val_des = \n', val_des)
    ...
    #debug
    print('train_gt is computed: ', train_gt)
    ...
    return extrapolate(B, train_des, val_des, train_gt)
